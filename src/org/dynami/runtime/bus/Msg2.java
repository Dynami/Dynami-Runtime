 ...
 *
 */
public enum Msg2 implements IMsg, IService {
	Broker;
	private boolean forceSync = false;
	private final static int SIZE = 1024 << 6;
	...
	private final Thread internal = new Thread(new Runnable() {
		...
		public void run() {
			while(!shutdown.get()){
				...
				// sleep execution for a nano second, otherwise sometimes raise null pointer exception
